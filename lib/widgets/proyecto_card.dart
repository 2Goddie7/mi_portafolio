   ...
   return Container(
     ...
     child: Column(
       ...
       children: [
         ...
         // Título del proyecto
         Text(
           'Sistema de Gestión de Procesos Museisticos', // 👈 CAMBIA ESTE TEXTO
           style: TextStyle(
             fontSize: 20,
         ...
         Text(
           'Aplicación web para gestionar pasantes, visitas, visitantes y donaciones, '
           'Gestión de visitas y donaciones, desarrollada'
           'como proyecto de integración curricular.', // 👈 CAMBIA ESTE TEXTO
           style: TextStyle(
             fontSize: 14,
         ...
         Container(
           ...
           child: Text(
             'NODE • REACT • JAVASCRIPT', // 👈 CAMBIA ESTE TEXTO
             style: TextStyle(
               fontSize: 12,
